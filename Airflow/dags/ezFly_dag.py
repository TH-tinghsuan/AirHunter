...
from modules.crawler import get_ezFly_raw_data, scrape_and_upload_s3
from modules.transfer import clean_data_ezFly
from modules.notification import notify_on_failure


class TaskID:
    ezF_crawler_task_1_id = "crawler_task_1"
    ezF_crawler_task_2_id = "crawler_task_2"
    ezF_crawler_task_3_id = "crawler_task_3"
    ezF_clean_task_id = "clean_and_load_task"
...
def ezFly_pipeline():
    crawl_task_1 = PythonOperator(task_id=TaskID.ezF_crawler_task_1_id,
